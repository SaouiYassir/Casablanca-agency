...
function Catalogue({ preview = false }) {
  ...
  return (
    <div className="catalogue-section catalogue-page">
      <PageMeta title="Catalogue" description="Découvrez les voitures disponibles à la location à Casablanca et envoyez votre demande par WhatsApp." path="/all-cars" />
